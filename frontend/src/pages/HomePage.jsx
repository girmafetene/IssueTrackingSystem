...
function Home() {
 ...
 {/* {
  !show?
       (<Icon icon="ion:menu" onClick={showButon}/>): 
       (<Icon icon="ic:round-close" onClick={showButon}/>)
}  */}
      </div>
      </div>
...
<footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://www.getnetsoft.com/" class="hover:underline">GETNET™</a>. All Rights Reserved.
          </span>
